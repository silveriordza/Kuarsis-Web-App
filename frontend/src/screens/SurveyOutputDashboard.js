...
const SurveyOutputDashboard = props => {
   const srcFileName = 'SurveyOutputDashboard'
   const log = new LoggerSettings(srcFileName, 'SurveyOutputDashboard')
...
export default SurveyOutputDashboard
