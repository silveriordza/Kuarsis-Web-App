...
//--------------------------------------------------------------------------------------------------------------------------------------------------
Git Dev Tag: (pending)
Git feature branches: tagkuarxisBeSurveySystemDEV-v1.0.0.4->kuarxisFeSurveySystemDev-MonkeyIntegration1.0->kuarxisBeSurveySystemDev-MonkeyIntegration1.0-ClaculatedFieldsRedesign1.0
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
Git Dev Tag: (pending)
Git feature branches: tagkuarxisBeSurveySystemDEV-v1.0.0.4->kuarxisFeSurveySystemDev-MonkeyIntegration1.0->
Version date: 1/07/24
Modificator name: Silverio Rodriguez Alcorta
ENHANCEMENTS:
